...
Se incluye una colección de Postman en la raíz del proyecto (`MundialitoCorp Api.postman\_collection.json`) con todos los endpoints configurados para facilitar las pruebas de la API.
